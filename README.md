...
- `README.md`、`.gitignore`
- `StarDict/`、`MDict/`、`EudicTranslationEngine/` 下的目录结构
...
| `MDict/`                  | MDict `.mdx/.mdd`                       |      约 3.8 GB，8 套词典 | HTML 词典，适配多种 MDict 兼容阅读器 |
| `EudicTranslationEngine/` | Eudic Translation Engine `.eudb/.eudic` | 约 340 KB，10 个插件文件 | 欧路词典在线翻译源配置               |
...
| -------------------------- | ------------------------------------------------------------- | ------------- | --------------------- |
| `MDict/OALD9/`             | Oxford Advanced Learner's Dictionary 9th edition              | `Encrypted=2` | `.mdd`、`.css`、图片  |
...
| -------------------------------------------- | ------------------------- | ---------------------- | -------: |
| `EudicTranslationEngine/new_version_eudb/`   | `oln_trans_baidu.eudb`    | 百度在线翻译引擎       | 20211028 |
| `EudicTranslationEngine/new_version_eudb/`   | `oln_trans_bing.eudb`     | Bing 在线翻译引擎      | 20211028 |
| `EudicTranslationEngine/new_version_eudb/`   | `oln_trans_deepl.eudb`    | DeepL 在线翻译引擎     | 20231225 |
| `EudicTranslationEngine/new_version_eudb/`   | `oln_trans_tencent.eudb`  | 腾讯交互式在线翻译引擎 | 20230918 |
| `EudicTranslationEngine/new_version_eudb/`   | `oln_trans_volcano.eudb`  | 火山在线翻译引擎       | 20230918 |
| `EudicTranslationEngine/new_version_eudb/`   | `oln_trans_youdao.eudb`   | 有道在线翻译引擎       | 20230918 |
| `EudicTranslationEngine/prev_version_eudic/` | `oln_trans_baidu.eudic`   | 百度在线翻译引擎       | 20211028 |
| `EudicTranslationEngine/prev_version_eudic/` | `oln_trans_bing.eudic`    | Bing 在线翻译引擎      | 20211028 |
| `EudicTranslationEngine/prev_version_eudic/` | `oln_trans_tencent.eudic` | 腾讯交互式在线翻译引擎 | 20230918 |
| `EudicTranslationEngine/prev_version_eudic/` | `oln_trans_volcano.eudic` | 火山在线翻译引擎       | 20230918 |
...
`EudicTranslationEngine/new_version_eudb/` 面向较新版本欧路词典，`EudicTranslationEngine/prev_version_eudic/` 面向旧版本。导入方式取决于欧路词典版本和平台，请优先参考欧路词典的插件/翻译引擎导入说明。
