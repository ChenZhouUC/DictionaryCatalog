...
| ----------- | --------------------------------------- | -----------------------: | ------------------------------------ |
| `StarDict/` | StarDict `.ifo/.idx/.dict`              |     约 215 MB，13 套词典 | 离线词典查询，中英/汉英/汉语词典     |
| `MDict/`    | MDict `.mdx/.mdd`                       |     约 4.2 GB，15 套词典 | HTML 词典，适配多种 MDict 兼容阅读器 |
...
| `StarDict/牛津现代英汉双解词典/` | 牛津现代英汉双解词典    |  39,429 | 英汉双解                              |
